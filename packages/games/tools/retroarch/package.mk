...
make_target() {
  make HAVE_LIBRETRODB=1 HAVE_NETWORKING=1 HAVE_LAKKA=1 HAVE_LAKKA_PROJECT="PipBoy" HAVE_LAKKA_SERVER="https://github.com/ricardoalvarenga101/pipboy/releases" HAVE_ZARCH=1 HAVE_QT=0 HAVE_LANGEXTRA=1
